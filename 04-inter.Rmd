...
These processes are always stationary, no matter the values that the parameters may takes. The reason for this property is due to the fact that MA processes are linear process (see Definition \@ref(def:lp)) which are, under very mild conditions, weakly stationary processes. The following example 
