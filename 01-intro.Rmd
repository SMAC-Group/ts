...
```{remark, label="drift"}
You may argue that the definition of this model is not useful it constitutes a simple linear model. However this model is often accompanied by other time series models (as the ones presented)
```
