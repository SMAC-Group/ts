...
```{theorem, label="condexp", name="Minimum Mean Square Error Predictor"}
Let us define
...
The proof of this theorem can be found in Appendix \@ref(#appendixc). This suggests that the best prediction is given by ${E_t}\left[ {{X_{t + j}}} \right]$
