...
MINGMING
>>>>>>> 449daa943743b852aeb86259664b0637af8fb547
...
In this case, we see that the AIC and HQ select an AR(8) model in accordance with the selection procedure based on the ACF. However the BIC selects a much smaller model (AR(3)). This can be expected since the BIC tends to "underfit" given that it's penalty term becomes larger with $T$ with respect to the AIC and HQ.
