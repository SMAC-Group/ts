...
```{r, echo=FALSE, fig.asp = 0.75, fig.width = 9, cache = TRUE, fig.align='center', fig.cap="TO DO"}
# Define colors
...
```{r, fig.asp = 0.5, fig.width = 9, fig.align='center', fig.cap="TO DO"}
compare_acf(hydro)
```
...
```{r, fig.asp = 0.5, fig.width = 8, fig.align='center', fig.cap="TO DO"}
library(astsa)
