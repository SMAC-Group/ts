...
$$\frac{1}{\phi(B)}$$
it is obvious that there a solution (and therefore causality) only when $\phi(B) = \sum_{j = 0}^{\infty} \phi_j B^j \neq 0$. A condition for this to be respected is for the roots of $\phi(B) = 0$ to lie outside the unit circle.
