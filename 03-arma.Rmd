...
```{r, cache = TRUE, fig.asp = 0.6, fig.width = 7, fig.align='center', fig.cap="Empirical PACF of the yearly lynx trapping time series."}
plot(auto_corr(lynx_gts, pacf = TRUE)) 
```
...
```{r, eval = TRUE, cache = TRUE, echo = FALSE, fig.asp = 0.6, fig.width = 7, fig.align='center', fig.cap="Values of the three model selection criteria described in the text for all candidate models included in an AR(16) model for the yearly lynx trapping time series."}
