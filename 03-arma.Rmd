...
```{r, fig.align='center', fig.height=4.5, fig.width=9, fig.cap="TO DO", echo = FALSE, warning=FALSE, message=FALSE, error=FALSE}
# plot the results
par(mfrow=c(1,2))
mycolor = hcl(h = seq(15, 375, length = 4), l = 65, c = 100, alpha = 1)
...
lynx_select = try(simts::select(AR(15), lynx_gts, include.mean = TRUE))
```
