...
```{r AR1theoACF, cache = TRUE, echo = FALSE, fig.cap = "Comparison of theoretical ACF of AR(1) with different values of phi (i.e. phi = 0.9, 0.5, 0.1)", fig.align='center', fig.height = 6, fig.width = 10}
par(mfrow=c(2,2))
