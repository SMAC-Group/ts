...
```{r AR1theoACF, cache = TRUE, echo = FALSE, fig.cap = "Comparison of theoretical ACF of AR(1) with different values of phi (i.e. phi = 0.9, 0.5, 0.1)", fig.align='center', fig.height = 4, fig.width = 10}
par(mfrow=c(1,3))
plot(theo_acf(ARMA(ar = 0.9, ma = NULL)), 
     main = expression(paste("Theoretical ACF plot of AR1 with ", phi, " = 0.9")))
plot(theo_acf(ARMA(ar = 0.5, ma = NULL)),
     main = expression(paste("Theoretical ACF plot of AR1 with ", phi, " = 0.5")))
plot(theo_acf(ARMA(ar = 0.1, ma = NULL)), 
     main = expression(paste("Theoretical ACF plot of AR1 with ", phi, " = 0.1")))
