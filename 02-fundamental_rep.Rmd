...
With this setup, we demonstrate how crucial this property is by calculating each of the requirements of a stationary process.
  ...
  meaning that as $|\phi|$ gets smaller the autocorrelation reaches zero at a faster rate (on the contrary, if $|\phi|$ is close to 1 then the decay rate is slower), which can be better illustrated in the following plots.
```

```{r AR1theoACF, cache = TRUE, echo = FALSE, fig.cap = "Comparison of theoretical ACF of AR1 with different values of phi (i.e. phi = 0.9, 0.5, 0.1)", fig.align='center', fig.height = 4, fig.width = 10}
par(mfrow=c(1,3))
