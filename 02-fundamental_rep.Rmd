...
for(i in 1:B) {
  ...
  # Store ACF values
  acf_xt[i, ] = as.numeric(simts::auto_corr(Xt))[1:15]
  acf_yt[i, ] = as.numeric(simts::auto_corr(Yt))[1:15]
...
for(i in 1:B) {
  ...
  cl_acf[i, ] = as.numeric(simts::auto_corr(Yt))[1:15]
...
for(i in 1:B) {
  ...
  # Store Classic and Robust ACF values
  cl_acf[i, ] = as.numeric(simts::auto_corr(Xt))[1:15]
