...
par(mfrow = c(1,2))
boxplot(acf_xt[, 3], col = "grey80", main = "Empirical Distribution of ACF at lag 3 (uncontaminated)")
abline(h = true_acf[3], col = "red")
boxplot(acf_yt[, 3], col = "grey80", main = "Empirical Distribution of ACF at lag 3 (contaminated)")
abline(h = true_acf[3], col = "red")
```
...
par(mfrow = c(1,2))
boxplot(cl_acf[, 2], col = "grey80", main = "Empirical Distribution of Classic ACF at lag 2")
abline(h = true_acf[2], col = "red")
boxplot(rob_acf[, 2], col = "grey80", main = "Empirical Distribution of Robust ACF at lag 2")
abline(h = true_acf[2], col = "red")
```
...
previous one is the value of $\epsilon$ set equal to $0$; the code shall thus be omitted and the results are depicted below:
...
# Make boxplots of both Classic and Robust Empirical ACF and compare with true ACF
par(mfrow = c(1,2))
boxplot(cl_acf[, 4], col = "grey80", main = "Empirical Distribution of Classic ACF at lag 5")
abline(h = true_acf[4], col = "red")
boxplot(rob_acf[, 4], col = "grey80", main = "Empirical Distribution of Robust ACF at lag 5")
abline(h = true_acf[4], col = "red")
```
